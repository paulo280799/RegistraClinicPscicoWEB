    ...
    <fieldset>
      ...
      <div class="row" >
        ...
        <div class="form-group col-sm-3">
          ...
          <input type="date" name="dataCadastro" value="<?php echo $dataCadastro; ?>" class="form-control" required>
        </div>
        ...
        <div class="form-group col-sm-3">
          ...
          <input type="date" name="dataNascimento" value="<?php echo $dataNascimento; ?>" class="form-control" required>
        </div>
